...
```text
+-------------------------------------------------------+
|  MY-LINK [Admin]                     [내 페이지 보기 🔗] |  <-- 우측 상단 고정 버튼
+-------------------------------------------------------+
|                                  [로그아웃]             |
|                                                       |
|  (  Avatar  )  이름: [ HaeSeul      ] ✎               |  <-- ✎ 연필 아이콘 (편집 가능 표시)
|                소개: [ 한 줄 소개... ] ✎               |
|                                                       |
+-------------------------------------------------------+
|                                                       |
...
### 5.3 주요 기능 사양 (Admin)
- **고정 네비게이션**: '내 페이지 보기' 버튼은 화면 우측 상단에 고정되어 있어, 편집 중 언제든지 결과물을 확인할 수 있습니다.
- **편집 가능 표시 (Pencil Icon)**: 사용자가 로그인 상태일 때 모든 편집 가능한 필드(이름, 소개, 링크 제목, URL) 옆에 연필 아이콘(✎)이 항상 노출되어 직관적인 편집을 유도합니다.
